<template>
  ...
  <div id="happyCustomers">
    ...
    <div class="md-layout md-gutter">
      ...
      <div class="md-layout-item md-size-25 margin-bottom-2vh" v-for="happyCustomer in this.happyCustomers"  :key="happyCustomer">
        <img v-if="happyCustomer.type == 'foto'" :src="happyCustomer.fotoNaam"></img>

        <div v-else class="input-wrapper ta-center margin-50-top-bottom">
        <md-card-header>
            <div class="md-title">{{happyCustomer.naam}}</div>
          </md-card-header>
        <p>{{happyCustomer.tekst}}</p>
      </div>
      </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
          ...
          axios
          .post('/get-happy-customers', {'searchInput': ''})
