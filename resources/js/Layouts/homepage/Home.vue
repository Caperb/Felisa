<template>
  ...
  <p class="md-display-3">Lorem ipsum dolor sit amet consectetur Lorem ipsum dolor sit amet consectetur Lorem ipsum dolor sit amet consectetur</p>
  <img src="https://picsum.photos/1920/900"></img>
  </div>
</div>
  <!-- Products -->
  <div id="products">
    <h2 class="section-titel">Products.</h2>
...
<h2 class="all-products-link clickable" @click="setPage('shop')">See all available products</h2>
  </div>
  ...
  <!-- Customers -->
  <div id="customers">
    <h2 class="section-titel">Happy customers.</h2>
  ...
  <h2 class="all-products-link clickable">See all Happy Customers</h2>
  </div>
